...
class HXRecord1ModifyKeyValueModel extends HXRecord1BaseModel {
  ...
  const HXRecord1ModifyKeyValueModel({
  ...
  factory HXRecord1ModifyKeyValueModel.fromMap(Map<String, dynamic> map) {
