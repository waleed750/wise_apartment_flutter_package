// Doc fields: openMode, normalyOpenMode, volumeEnable, systemiVolume, shakeAlarmEnable, lockCylinderAlarmEnable, antiLockEnable, lockCoverAlarmEnable, systemLanguage
import 'package:wise_apartment/src/models/records/gen1/hx_record1_base_model.dart';
import 'package:wise_apartment/src/models/records/shared/record_base_parsers.dart';

class HXRecord1SetSysPramModel extends HXRecord1BaseModel {
  final int openMode;
  ...
  const HXRecord1SetSysPramModel({
  ...
  factory HXRecord1SetSysPramModel.fromMap(Map<String, dynamic> map) {
    ...
    return HXRecord1SetSysPramModel(
