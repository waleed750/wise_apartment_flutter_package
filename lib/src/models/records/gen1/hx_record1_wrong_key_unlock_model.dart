...
class HXRecord1WrongKeyUnlockModel extends HXRecord1BaseModel {
  ...
  const HXRecord1WrongKeyUnlockModel({
  ...
  factory HXRecord1WrongKeyUnlockModel.fromMap(Map<String, dynamic> map) {
    ...
    return HXRecord1WrongKeyUnlockModel(
