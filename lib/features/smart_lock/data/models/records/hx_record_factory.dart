...
import 'package:wise_apartment/features/smart_lock/data/models/records/gen2/hx_record2_factory.dart' as gen2;
import 'package:wise_apartment/features/smart_lock/data/models/records/gen1/hx_record1_factory.dart' as gen1;
import 'package:wise_apartment/features/smart_lock/data/models/records/shared/hx_record_unknown_model.dart';
...
HXRecordBaseModel hxRecordFromMap(Map<String, dynamic> map) {
  ...
  try {
    ...
    if (modelType.contains('Record2') || modelType.toLowerCase().contains('hxrecord2')) {
